...
- **Base units vest only for months actively worked.** "Active" is defined objectively in the operating agreement (e.g., ≥20 hrs/week, board-certified quarterly). Example: active for the first 8 of 12 months → 8/48 of 5% ≈ **0.83% vested**. As part of ratification, deem the 1-year cliff satisfied for the five original founders and count actual months served — a strict cliff would zero out anyone inactive before month 12, violating the spirit of the original "guaranteed allocation" promise, and cliff waiver is the carrot that buys the unanimous signatures the framework requires ([vesting-as-commitment rationale: Wasserman 2012](https://press.princeton.edu/books/paperback/9780691158303/the-founders-dilemmas)).
...
- **Pause, then deemed separation.** Inactivity *pauses* vesting (resumable if the founder returns). After 6 consecutive months inactive: written board notice + 60-day cure window → if no return, deemed departure. Unvested base units repurchased at cost; vested units kept per leaver status — good leaver (cooperates, signs) keeps vested subject to ROFR/drag-along; bad leaver (breach, refusal, competing) faces repurchase of even vested units at cost ([Bird & Bird](https://www.twobirds.com/en/insights/2025/leaver-provisions-the-terms-that-founders-fear-the-most); [Ashfords](https://www.ashfords.co.uk/insights/blog/leaver-provisions-balancing-founder-fairness-and-company-protection)).
...
- **Worst-case dead equity is bounded:** two founders permanently inactive from month 8 ≈ 1.7% total — far below the 10–15% investor red-flag threshold ([Capbase](https://capbase.com/founder-vesting-schedules-best-practices/)).
